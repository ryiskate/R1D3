"""
Script to directly modify the database schema to match our updated models.
This will:
1. Add the status column to strategy tables if it doesn't exist
2. Copy data from is_completed to status
3. Remove the is_completed column
"""
import os
import django
import sqlite3
...
def fix_strategy_milestone_table(conn):
    ...
    print("\n=== FIXING STRATEGY MILESTONE TABLE ===")
