document.addEventListener('DOMContentLoaded', function() {
    ...
    const updateCampaign = document.getElementById('updateCampaign');
    ...
    const batchCampaign = document.getElementById('batchCampaign');
    const batchChannel = document.getElementById('batchChannel');
    ...
    if (updateCampaign) {
        updateCampaign.addEventListener('change', function() {
            batchCampaign.disabled = !this.checked;
        });
    }
    
    if (updateChannel) {
        updateChannel.addEventListener('change', function() {
            batchChannel.disabled = !this.checked;
        });
    }
    ...
    if (applyBatchUpdateBtn) {
        applyBatchUpdateBtn.addEventListener('click', function() {
            ...
            if (updateCampaign.checked && batchCampaign.value) {
                updateData.campaign_id = batchCampaign.value;
            }
            
            if (updateChannel.checked && batchChannel.value) {
                updateData.channel = batchChannel.value;
            }
